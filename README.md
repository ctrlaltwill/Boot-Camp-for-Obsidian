...
> [!NOTE]
> Alpha 0.0.3 has just been released – this is a massive update to the alpha and some parsing errors may require you to update your flashcards. A tutorial, better description and screenshots of the ne user interface will be released in the coming weeks. I also plan on releasing a new version with system/Obsidian adaptive theme designed around shadcn/ui and the Cupertino theme for Obsidian! 
